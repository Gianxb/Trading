...
try:
    ...
    if age >= 18:
        ...
        if t1.amount > 100000:
            print(f"Congratulations {t1.name}, your return on the Dow Jones is {t1.amount-10000} CHF")
        else:
            print(f"Oh no! {t1.name}, your return on the Dow Jones is {t1.amount-10000} CHF")
    else:
